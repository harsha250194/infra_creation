...
variable "use2_vpc_cidr" {
  description = "use2 cidr block for rds"
  default = null
}

variable "usw1_vpc_cidr" {
  description = "usw1 cidr block for rds"
  default = null
}
...
variable "use2_rds_kms_key" {
  description = ""
  default     = null
}

variable "usw1_rds_kms_key" {
  description = ""
  default     = null
}
...
variable "use2_cluster_instance_count" {
  description = ""
}

variable "usw1_cluster_instance_count" {
  description = ""
}
...
variable "use2_subnet_ids" {}

variable "usw1_subnet_ids" {}
...
variable "use2_vpc_id" {}

variable "usw1_vpc_id" {}
